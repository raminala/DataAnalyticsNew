...
I primarily selected this dataset because of availability of a lot of numerical and categorical variables. The problem with that was lack of knowledge about many variables and errors in data like percents more than 100% and lots of 0 and NA in dataset.
...
1. **How energy consumption and access has changed over the years, and in rural/urban area?**

2. **How does gas price is changing in populated countries over the years?**

3. **Which countries are affected most due to electrical outages and present the amount of impact?**
