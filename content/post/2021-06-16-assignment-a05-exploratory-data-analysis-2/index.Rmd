...
replace_with_na($access_to_electricity_percent_of_population > 100, access_to_electricity_percent_of_population <- 20)
...
My_data2 %>%
  ...
  ggplot(aes(year, pump_price_for_diesel_fuel_us_per_liter))+ geom_line(color="red")+geom_smooth(method = "lm")
