...
1. Introduction:
  ...
  In this post, the solution for the assignment 02 is provided. I selected "Stroke Prediction Dataset" from https://www.kaggle.com/datasets because I have had some basic studies on this topic, and I am eager to add more information while doing my assignment.
...
5. discussion
  ...
  In this assignment, the Stroke Prediction dataset became more understandable by employing the capabilities of two libraries: dplyr and tidyr. The result of this section could be used in visualization using ggplo2. The important skill in this section is using cheetshets to apply new function on a dataset. 
  
  There were two challenges for me in this exercise:
  
  - I used another machine when I tried to do this exercise. It took some time for me to figure out how to pull repository from git and use that (because I used to push to git not pull!).
  
  - In the selected dataset, bmi variable's class was "character" instead of numeric.